/**
 * Lightweight header for ConstraintPoseImu and Matrix15d.
 *
 * Extracted from G2oTypes.hpp to break the g2o dependency
 * for files that only need the IMU prior constraint struct.
 */
